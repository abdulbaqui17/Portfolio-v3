  ...
  return (
    <section id="education" className="px-6 md:px-10 py-24 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-[120px_1fr] gap-8 mb-10 items-baseline pb-6 border-b border-white/15">
        <div className="font-mono text-base text-orange-400 tracking-widest">05 / BACKGROUND</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="rounded-2xl border border-white/15 bg-neutral-950/60 p-6 md:p-8">
          ...
          <h3 className="text-2xl md:text-3xl font-light tracking-tight leading-tight mb-2">B.Tech, Computer Science</h3>
        ...
        <div className="rounded-2xl border border-white/15 bg-neutral-950/60 p-6 md:p-8">
          ...
          <h3 className="text-2xl md:text-3xl font-light tracking-tight leading-tight mb-4">What I can point to</h3>
          <ul className="space-y-3 text-lg">
            {[
              ...
              <li key={n} className="flex gap-4">
                <span className="font-mono text-orange-400 w-10 flex-shrink-0 font-medium">{n}</span>
