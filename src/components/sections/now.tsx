  ...
  return (
    <section id="now" className="px-6 md:px-10 py-24 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-[120px_1fr] gap-8 mb-10 items-baseline pb-6 border-b border-white/15">
        <div className="font-mono text-base text-orange-400 tracking-widest">01 / NOW</div>
      ...
      >
        ...
        <div className="relative rounded-2xl bg-neutral-950 p-8 md:p-10">
          ...
          <h3 className="text-4xl md:text-5xl font-light tracking-tight mb-4 leading-[1.05]">
            JARVIS — a voice agent that doesn&apos;t phone home.
          </h3>
          <p className="text-neutral-200 max-w-2xl leading-relaxed mb-8">
