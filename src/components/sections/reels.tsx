    ...
    <section id="reels" className="px-6 md:px-10 py-24 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {reels.map((url, i) => {
          ...
          return (
            <HoverStack key={url} tilt={i % 2 === 0 ? -14 : 14} scale={1.03} className="relative rounded-2xl">
            <div
              className="rounded-2xl border border-white/15 bg-neutral-950/60 overflow-hidden flex flex-col"
            >
